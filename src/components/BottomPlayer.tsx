      ...
      <div className="mx-auto flex h-20 max-w-screen-2xl items-center gap-4 px-4">
        ...
        <div className="flex flex-1 flex-col items-center gap-1">
          ...
          <div className="flex w-full max-w-md items-center gap-2">
            <span className="text-[11px] text-muted-foreground tabular-nums">1:18</span>
            <Slider
              value={[progress]}
              ...
              className="flex-1"
            />
            <span className="text-[11px] text-muted-foreground tabular-nums">{currentTrack.duration}</span>
          </div>
        </div>
